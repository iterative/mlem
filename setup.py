...
setup_args = dict(  # noqa: C408
    ...
    entry_points={
        ...
        "mlem.contrib": [
            ...
            "k8s_service_type.clusterip = mlem.contrib.kubernetes.base:ClusterIPService",
            ...
            "k8s_service_type.loadbalancer = mlem.contrib.kubernetes.base:LoadBalancerService",
            "k8s_service_type.nodeport = mlem.contrib.kubernetes.base:NodePortService",
            "k8s_service_type.kubernetes = mlem.contrib.kubernetes.base:ServiceType",
        ...
        "mlem.config": [
            ...
            "aws = mlem.contrib.sagemaker.meta:AWSConfig",
