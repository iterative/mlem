...
setup_args = dict(  # noqa: C408
    ...
    entry_points={
        ...
        "mlem.contrib": [
            ...
            "dataset_type.fastai_category = mlem.contrib.fastai:CategoryDataType",
            "dataset_type.fastai_pil_image = mlem.contrib.fastai:PILImageDataType",
            ...
            "model_io.fastai = mlem.contrib.fastai:FastAIModelIO",
            ...
            "model_type.fastai = mlem.contrib.fastai:FastAIModel",
