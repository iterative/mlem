...
setup_args = dict(  # noqa: C408
    ...
    entry_points={
        ...
        "mlem.contrib": [
            ...
            "data_type.tensorflow = mlem.contrib.tensorflow:TFTensorDataType",
            ...
            "model_io.tensorflow_io = mlem.contrib.tensorflow:TFKerasModelIO",
            ...
            "model_type.tensorflow = mlem.contrib.tensorflow:TFKerasModel",
